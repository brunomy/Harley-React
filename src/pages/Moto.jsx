...
export default function Moto() {
    const banner = {
        img: '/harley-react/src/assets/images/moto_banner[1920x850].png',
    ...
    const moto_colors = [
        {
            color: '#000000',
            img: '/harley-react/src/assets/images/motoColor[850x500].png'
        },
        {
            color: '#AE0E0E',
            img: '/harley-react/src/assets/images/motoColor2[850x500].png'
        },
        {
            color: '#6a6a6a',
            img: '/harley-react/src/assets/images/motoColor3[850x500].png'
        },
        {
            color: '#7e929d',
            img: '/harley-react/src/assets/images/motoColor4[850x500].png'
        }
    ]
    const video_info = {
        img: '/harley-react/src/assets/images/video%5B1920x640%5D.png', 
        videoUrl: 'https://www.youtube.com/watch?v=eJpD9IV2feE'
    }
    const galeria = [
        {
            img: '/harley-react/src/assets/images/galeria1%5B1100x500%5D.png',
            width: '1100',
            height: '500',
        },
        {
            img: '/harley-react/src/assets/images/categoria%5B1920x990%5D.png',
            width: '1920',
            height: '990',
        },
        {
            img: '/harley-react/src/assets/images/banner%5B1750x850%5D.png',
            width: '1750',
            height: '850',
        },
        {
        ...
        {
            img: '/harley-react/src/assets/images/moto_banner%5B1920x850%5D.png',
            width: '1920',
            height: '850',
        }
    ]
    ...
    const listaBlog = [
        {
            link: '/',
            img: '/harley-react/src/assets/images/blog%5B375x190%5D.png',
